...
I am now expanding that foundation through hands-on work with modern open-source IAM platforms such as Keycloak, FreeIPA, and Authentik, alongside AWS IAM, with a particular focus on extending identity, authentication, authorization, and Single Sign-On concepts from traditional on-premises environments into hybrid and cloud-based architectures using technologies such as SAML, OAuth 2.0, and OpenID Connect (OIDC). I am also exploring WireGuard for next-generation VPN connectivity.

In parallel, I am developing skills in security monitoring, log analysis, SIEM platforms (Wazuh, Splunk), intrusion detection and prevention technologies (Suricata, Zeek, Snort), vulnerability management (Nessus, OpenVAS), incident response, and cloud security services (CloudTrail, GuardDuty, Security Hub) as I continue building toward security-focused infrastructure and cybersecurity roles.
