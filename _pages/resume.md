...
### Worker-Owned Restaurant Corporation \| *Athens, Ohio* \| 2004–2013
  * **Network Infrastructure:** Designed and implemented the organization's network infrastructure, including structured cabling, deploying secure WLANs, implementing VLAN segmentation, and managing a pfSense firewall. Extending secure connectivity to remote offices by encrypted site-to site VPNs using OpenVPN.
  ...
  * **Identity & Access Management:** Implemented centralized identity and access management (IAM) using OpenLDAP, Samba, and Kerberos, enabling Single Sign-On (SSO) across multiple applications and integration with Google Workspace using OAuth.
